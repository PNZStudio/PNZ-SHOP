...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/css/pnz.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css" integrity="sha384-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">

    <title>PNZ : SHOP</title>
  </head>
  <body>
    ...
    <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="" class="nav-link active">เข้าสู่ระบบ | สมัครสมาชิก</a>
                </li>
            </ul>
    </div>
    </nav>
    ...
    <div class="container-fluid">
        <a href="" class="navbar-brand"><i class="fas fa-spider"></i> PNZ SHOP</a>
            <ul class="navbar-nav mr-auto"></ul>
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="" class="nav-link">
                    <i class="fas fa-shopping-bag"></i> ตระกร้าสินค้า
                    </a>
                </li>
            </ul>
